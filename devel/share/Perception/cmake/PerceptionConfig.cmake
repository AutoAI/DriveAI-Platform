...
if("TRUE" STREQUAL "TRUE")
  set(Perception_SOURCE_PREFIX /home/mattbowyer/Driveai-platform/src/Perception)
  set(Perception_DEVEL_PREFIX /home/mattbowyer/Driveai-platform/devel)
  ...
  set(Perception_INSTALL_PREFIX /home/mattbowyer/Driveai-platform/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mattbowyer/Driveai-platform/src/Perception/${idir}'.  Ask the maintainer 'Parth Mehrotra <parth.mehrotra@driveai.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mattbowyer/Driveai-platform/devel/lib;/home/mattbowyer/Driveai-platform/devel/lib;/opt/ros/indigo/lib)
