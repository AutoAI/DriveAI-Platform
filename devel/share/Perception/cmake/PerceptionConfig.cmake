...
if("TRUE" STREQUAL "TRUE")
  ...
  set(Perception_INSTALL_PREFIX /home/parthmehrotra/Projects/HighPriority/DriveAI/DriveAI-Platform/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'Perception' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'parthmehrotra <parthmehrotra@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'Perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parthmehrotra/Projects/HighPriority/DriveAI/DriveAI-Platform/src/Perception/${idir}'.  Ask the maintainer 'parthmehrotra <parthmehrotra@todo.todo>' to fix it.")
    endif()
